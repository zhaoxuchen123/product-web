...
const boards = [
  {
    ...
    notes: [
      ...
      '芯驰 D9 飞凌板卡上需配置 snps,clk-csr = <4>，用于 MDC 时钟分频',
    ],
    snippet:
`ethernet1: eth@306A0000 {
  compatible = "semidrive,dwc-qos-ethernet", "snps,dwmac-4.10a";
...
::: warning 注意
在芯驰 D9 飞凌板卡上，DW 网卡设备树需要配置 `snps,clk-csr = <4>;`，用于 MDC 时钟分频。
:::
