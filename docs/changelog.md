...
const entries = [
  { year: 2026, product: '网络工具',    icon: Terminal, pkg: 'netfirewall',        version: '1.1.0',     type: 'minor', typeLabel: '功能', date: '2026-05-22', link: '/products/tools/netfirewall',        items: ['新增 `netfw_md` 流量控制工具说明', '新增 `flowctl.json` JSON 配置说明', '支持基于令牌桶的包速率和带宽限速', '支持 MAC、IPv4、端口等多维度匹配'] },
  ...
  { year: 2025, product: '网络工具',    icon: Terminal, pkg: 'netfirewall',        version: '1.0.0',     type: 'minor', typeLabel: '发布', date: '2025-10-28', link: '/products/tools/netfirewall',        items: ['初始版本发布，提供 SylixOS 网络防火墙框架', '新增 `/dev/netfw` 控制接口与驱动控制扩展', '新增 `CLASSIFY_NONE_LEVEL` 分类级别'] },
